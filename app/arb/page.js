              ...
              {results && (
                <>
                  {results.warnings.length > 0 && (
                    <div style={{ padding: '12px', background: 'rgba(255,170,0,0.1)', border: '1px solid #f97316', borderRadius: '8px', color: '#f97316', fontSize: '0.8rem', marginBottom: '16px', lineHeight: '1.5' }}>
