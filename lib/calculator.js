...
export function getCompoundInfo(compound) {
  const info = {
    street: { name: 'Street', emoji: '🛣️', color: '#ff6b35', description: 'Ban harian aspal' },
    ...
    race: { name: 'Race / Slick', emoji: '🏁', color: '#ff2d78', description: 'Aspal balap, grip max' },
    drift: { name: 'Drift', emoji: '💨', color: '#7b61ff', description: 'Khusus untuk sideways!' },
    drag: { name: 'Drag', emoji: '🚀', color: '#00ff88', description: 'Trek lurus, launch max' },
    rally: { name: 'Rally', emoji: '🌍', color: '#c8a44e', description: 'Tanah & aspal campuran' },
    snow: { name: 'Snow', emoji: '❄️', color: '#00d4ff', description: 'Salju dan es' },
